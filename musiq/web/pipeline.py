...
from musiq.web.circuit_json import circuit_from_payload
from musiq.web.ionq_runner import resolve_ionq_backend, run_ionq_shots
from musiq.web.simulator_light import simulate_ideal
from musiq.web.spectral_analysis import (
    analyze_waveform,
...
def generate_audio_from_payload(
    ...
    return {
        ...
        "saved_audio_filename": f"musiq_{datetime.now().strftime('%Y%m%d_%H%M%S')}.wav",
    }
