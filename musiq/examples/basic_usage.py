#!/usr/bin/env python3
"""
Basic Usage Example for Musiq

Demonstrates how to use Musiq modules to generate quantum audio.
"""
...
from musiq.utils.constants import SAMPLING_RATE, DEFAULT_DURATION, DEFAULT_SHOTS
