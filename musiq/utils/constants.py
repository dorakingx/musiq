...
# Project root: parent of the `musiq` package when running from a source checkout
_MUSIQ_PKG = Path(__file__).resolve().parent.parent
_candidate_root = _MUSIQ_PKG.parent
