...
from musiq.gui.visualization import WaveformPlotter, MultiPanelVisualizer
from musiq.modules.simulator import QuantumSimulator, GenerationCancelledError
from musiq.modules.generator import AudioGenerator
from musiq.modules.analyzer import SpectralAnalyzer
from musiq.modules.optimizer import QuantumOptimizer
from musiq.scripts.verify_quantum_walk import build_quantum_walk_circuit
...
from musiq.utils.backends import (
    BACKEND_AER,
    BACKEND_CHOICES,
    get_backend_label,
    parse_backend_type,
...
class MusiqGUI:
    """
    Main GUI application for Musiq quantum audio generation.
    """
    
    def __init__(self, root):
        """Initialize the GUI application."""
        self.root = root
        self.root.title("Musiq: Quantum Circuit Audio Generator")
    ...
    def generate_audio(self):
        ...
        def generate():
            try:
                ...
                filename = self.output_dir / f"musiq_{timestamp}.wav"
                waveform_png = self.waveform_image_dir / f"musiq_{timestamp}.png"
